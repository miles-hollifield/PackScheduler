...
public class StudentDirectoryTest {
	...
	public void testLoadStudentsFromFile() {
		...
		assertEquals(10, sd.getStudentDirectory().length);
		// Test invalid file
		Exception e = assertThrows(IllegalArgumentException.class, () -> sd.loadStudentsFromFile("test-files/noFile.txt"));
	...
	public void testAddStudent() {
		...
		Exception x = assertThrows(IllegalArgumentException.class, () -> sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, null, null, MAX_CREDITS));
		assertEquals("Invalid password", x.getMessage());
		
		// Test Student with invalid password - empty string
		Exception xx = assertThrows(IllegalArgumentException.class, () -> sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, "", "", MAX_CREDITS));
		assertEquals("Invalid password", xx.getMessage());
							
		//Test Student with invalid first name - null.
		Exception x1 = assertThrows(IllegalArgumentException.class, () -> sd.addStudent(null, LAST_NAME, ID, EMAIL, PASSWORD, PASSWORD, MAX_CREDITS));
		assertEquals("Invalid first name", x1.getMessage());
		
		//Test Student with invalid first name -empty string.
		Exception x11 = assertThrows(IllegalArgumentException.class, () -> sd.addStudent("", LAST_NAME, ID, EMAIL, PASSWORD, PASSWORD, MAX_CREDITS));
		assertEquals("Invalid first name", x11.getMessage());
		
		//Test Student with invalid last name - null.
		Exception x2 = assertThrows(IllegalArgumentException.class, () -> sd.addStudent(FIRST_NAME, null, ID, EMAIL, PASSWORD, PASSWORD, MAX_CREDITS));
		assertEquals("Invalid last name", x2.getMessage());
		
		//Test Student with invalid last name - empty string.
		Exception x22 = assertThrows(IllegalArgumentException.class, () -> sd.addStudent(FIRST_NAME, "", ID, EMAIL, PASSWORD, PASSWORD, MAX_CREDITS));
		assertEquals("Invalid last name", x22.getMessage());
		
		//Test Student with invalid id - null.
		Exception x3 = assertThrows(IllegalArgumentException.class, () -> sd.addStudent(FIRST_NAME, LAST_NAME, null, EMAIL, PASSWORD, PASSWORD, MAX_CREDITS));
		assertEquals("Invalid id", x3.getMessage());
		
		//Test Student with invalid id - empty string.
		Exception x33 = assertThrows(IllegalArgumentException.class, () -> sd.addStudent(FIRST_NAME, LAST_NAME, "", EMAIL, PASSWORD, PASSWORD, MAX_CREDITS));
		assertEquals("Invalid id", x33.getMessage());
		
		//Test Student with invalid email - null.
		Exception x4 = assertThrows(IllegalArgumentException.class, () -> sd.addStudent(FIRST_NAME, LAST_NAME, ID, null, PASSWORD, PASSWORD, MAX_CREDITS));
		assertEquals("Invalid email", x4.getMessage());
		
		//Test Student with invalid email - null.
		Exception x44 = assertThrows(IllegalArgumentException.class, () -> sd.addStudent(FIRST_NAME, LAST_NAME, ID, "", PASSWORD, PASSWORD, MAX_CREDITS));
	...
	public void testGetStudentById() {
		...
		sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, 
				PASSWORD, MAX_CREDITS);
		sd.addStudent("Mark", "Horner", "mfhorner", "mfhorner@ncsu.edu", "javadoc", "javadoc", 13);
		
		assertEquals(2, sd.getStudentDirectory().length);
		
		// Check that student can be retrieved
		Student s = sd.getStudentById("mfhorner");
		
		assertEquals("mfhorner", s.getId());
	}
